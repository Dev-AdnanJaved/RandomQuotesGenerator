...
const quotes = [
  "Zain, you're built for greatness—never doubt that.",
  "Keep rising, Zain—your story is just beginning.",
  "Zain, your mindset is your superpower.",
  "Every king was once a boy like you, Zain.",
  "Zain, hustle in silence—let success make the noise.",
  "Confidence looks good on you, Zain.",
  "Zain, never settle for average when you were born to stand out.",
  "Keep it real, stay strong, and shine bright—Zain style.",
  "Zain, every setback is a setup for a stronger comeback.",
  "You’re not just a boy, Zain. You’re a whole vibe.",
  "Zain, you’ve got the heart of a lion and the soul of a warrior.",
  "Lead with kindness, Zain—it’s the rarest strength.",
  "Zain, make them stop and wonder how you do it so effortlessly.",
  "Zain, stay humble, but let them feel your fire.",
  "Doubt kills more dreams than failure ever will—remember that, Zain.",
  "Zain, your energy is magnetic—use it wisely.",
  "Be fearless in chasing what sets your soul on fire, Zain.",
  "Zain, you’re the kind of person people remember.",
  "Strong mind, brave soul, kind heart—that’s you, Zain.",
  "Zain, legends aren’t born—they’re built.",
  "Zain, you are your only limit.",
  "Wake up. Level up. Repeat. That’s the Zain way.",
  "Zain, the world needs your light—don’t dim it.",
  "Zain, success follows those who dare to be different.",
  "You weren’t made to blend in, Zain. You were made to stand out.",
  "Zain, let your actions speak louder than your words.",
  "Never stop evolving, Zain—growth is your power.",
  "Zain, be the reason someone believes in good again.",
  "You define cool, Zain—not trends.",
  "Zain, let your journey be louder than the noise.",
  "Keep building, Zain—brick by brick, step by step.",
  "Zain, some chase dreams—others wake up and build them.",
  "Zain, your calm is stronger than any chaos.",
  "You’re not chasing clout, Zain—you’re chasing greatness.",
  "Zain, make it happen. Shock them all.",
  "Zain, success doesn’t ask for permission.",
  "They’ll try to copy, but Zain—there’s only one original.",
  "Zain, don’t wait for opportunities. Create them.",
  "You’ve got that quiet power, Zain. That unshakable vibe.",
  "Zain, your time is now—not someday.",
  "Zain, keep showing up. That’s how legends are made.",
  "When Zain walks in, even doubt walks out.",
  "Zain, chase goals, not approval.",
  "Zain, don’t be afraid to outgrow the old you.",
  "Even on your worst days, Zain, you’re still someone’s inspiration.",
  "Zain, be bold enough to start and strong enough to finish.",
  "Zain, be your own competition.",
  "They can’t stop you, Zain—unless you let them.",
  "Zain, your silence can speak volumes.",
  "Zain, you’re not just doing it—you’re owning it."
];
